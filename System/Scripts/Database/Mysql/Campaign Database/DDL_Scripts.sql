...
CREATE TABLE `campaign`.`campaign_instance` (
  ...
  CONSTRAINT `FK_Campaign_CampaignInstance` FOREIGN KEY (`CampaignId`) REFERENCES `campaign` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `campaign`.`message_template` (
  ...
  CONSTRAINT `FK_Campaign_MessageTemplate` FOREIGN KEY (`CampaignId`) REFERENCES `campaign` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `campaign`.`schedule` (
  ...
  CONSTRAINT `FK_Campaign_Schedule` FOREIGN KEY (`CampaignId`) REFERENCES `campaign` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
