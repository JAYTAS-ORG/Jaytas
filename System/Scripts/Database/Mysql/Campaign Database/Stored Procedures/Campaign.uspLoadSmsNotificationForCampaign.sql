...
CampaignRemainderSmsNotificationBlock:BEGIN
    ...
    INSERT INTO notification.sms_notification (NotificationId, SubscriptionId, MessageType, SourceType, SourceId, PhoneNumber, NotificationDate, NotificationTime, Message, Status)
	SELECT  uuid() 'NotificationId',
			CMP.SubscriptionId,
			2 'MessageType',
            1 'SourceType',
            CMP.CampaignId 'SourceId',
            CONT.PhoneNumber,
