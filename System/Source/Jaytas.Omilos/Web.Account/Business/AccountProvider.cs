...
namespace Jaytas.Omilos.Web.Service.Account.Business
{
	...
	public class AccountProvider : IAccountProvider
	{
		...
		public AccountProvider(IFacebookUserServiceClient facebookUserServiceClient, IMapper mapper, IUserRepository userRepository, ITokenProvider tokenProvider)
		{
