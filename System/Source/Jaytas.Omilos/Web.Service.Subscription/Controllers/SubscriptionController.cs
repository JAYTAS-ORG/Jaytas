...
namespace Web.Service.Subscription.Controllers
{
	...
	public class SubscriptionController : CrudByFieldBaseApiController<Jaytas.Omilos.Web.Service.Subscription.DomainModel.Subscription,
																	   Jaytas.Omilos.Web.Service.Models.Subscription.Subscription,
																       Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid>,
																       Guid, long>
	{
		...
		[ProducesResponseType(typeof(FriendlyError), (int)HttpStatusCode.InternalServerError)]
		[ProducesResponseType((int)HttpStatusCode.NotFound)]
		public async Task<IActionResult> Post([FromBody] Jaytas.Omilos.Web.Service.Models.Subscription.Subscription subscription)
		{
		...
		[ProducesResponseType(typeof(FriendlyError), (int)HttpStatusCode.InternalServerError)]
		[ProducesResponseType((int)HttpStatusCode.NotFound)]
		public async Task<IActionResult> Update(Guid id, [FromBody] Jaytas.Omilos.Web.Service.Models.Subscription.Subscription subscription)
		{
		...
		/// <returns></returns>
		protected override Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid> CreateCommand(Jaytas.Omilos.Web.Service.Models.Subscription.Subscription model, Guid resourceId)
		{
			return new Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid>(model, resourceId);
		}
		...
		/// <returns></returns>
		protected async override Task DeleteAsync(Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid> command)
		{
		...
		/// <param name="command"></param>
		/// <returns></returns>
		protected async override Task<IEnumerable<Jaytas.Omilos.Web.Service.Subscription.DomainModel.Subscription>> GetAllAsync(Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid> command)
		{
		...
		/// <param name="command"></param>
		/// <returns></returns>
		protected async override Task<Jaytas.Omilos.Web.Service.Subscription.DomainModel.Subscription> GetByIdAsync(Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid> command)
		{
		...
		/// <param name="model"></param>
		/// <returns></returns>
		protected async override Task UpdateAsync(Command<Jaytas.Omilos.Web.Service.Models.Subscription.Subscription, Guid> command, Jaytas.Omilos.Web.Service.Subscription.DomainModel.Subscription model)
		{
